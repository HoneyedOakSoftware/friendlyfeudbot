...
public class GrantCommand implements Command {
    ...
    public void runCommand(MessageReceivedEvent event, String[] args) {
        ...
        Optional<Long> refereeUserId = Optional.ofNullable(challenge.getRefereeUserId());
        if (refereeUserId.isPresent() && authorId == refereeUserId.get()) {
        ...
        BotUtils.sendMessage(channel, "Victory for challenge " + challenge.getChallengeCode() + " was granted to " + BotUtils.userLongIdToMention(challenge.getWinnerUserId()));
    }
}
