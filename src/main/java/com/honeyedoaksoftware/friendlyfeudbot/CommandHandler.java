...
public class CommandHandler {
	...
	@Autowired
	public CommandHandler(HelpCommand helpCommand, GrantCommand grantCommand, ListCommand listCommand, ChallengeCommand challengeCommand) {
		buildCommandMap(helpCommand, grantCommand, listCommand, challengeCommand);
	}

	private void buildCommandMap(HelpCommand helpCommand, GrantCommand grantCommand, ListCommand listCommand, ChallengeCommand challengeCommand) {
